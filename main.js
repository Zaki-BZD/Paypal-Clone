...
let mobileButtonsDiv=document.querySelector("header .mobile-buttons ")
...
// const width= new IntersectionObserver((e)=>{
//     e.forEach((entry)=>{
//         if (entry.isIntersecting){
//             entry.target.classList.add("fullx")
//         }else{
//             entry.target.classList.remove("fullx")

//         }
//     })
// })
// const shapesx=document.querySelectorAll(".emptyx")
// shapes.forEach((e)=>{
//     width.observe(e)
// })
console.log(shapes)
